...
![](RackMultipart20221101-1-sfy10i_html_b228cb9bcd8939dc.gif)

_Figure 1: Downloading Unity Hub, steps 1-3._

1. Open the downloaded installer.
2. Accept the license and terms.
3. Specify install location (default is fine).
4. You now have Unity Hub installed; it would launch if you left that option checked in the installer. If not, search for "Unity Hub" in the start menu search bar to launch.

![](RackMultipart20221101-1-sfy10i_html_b980a43751db13ba.gif)

_Figure 2: Running the installer, steps 5-7._
...
![](RackMultipart20221101-1-sfy10i_html_1a9b809da7ba3c10.png)

![](RackMultipart20221101-1-sfy10i_html_baaec2f0f451aa83.png)

![](RackMultipart20221101-1-sfy10i_html_ba308f11c326d214.png)

1. Follow the instructions to create a Unity account, including email confirmation.
2. Activating a license is easy once you have an account. Go to settings in Unity Hub and select the License Management tab. When "Activate New License" is selected, the Unity Personal License can be selected. ![](RackMultipart20221101-1-sfy10i_html_14a5bf6174255862.gif)
...
3. Choose the recommended release.
  1. Note: _During development, the SMART-Art team used Unity version 2020.3.8f1. The key is to get this version OR later._
4. _Configure Modules_
  1. _Deselect Microsoft Visual Studio Code (Unless this IDE is needed to continue development)._
  2. Now select the modules required to build to mobile, then hit next. We will need:
    1. IOS build support.
...
![](RackMultipart20221101-1-sfy10i_html_a457fa4b5321aaf5.gif)

_Figure 3: Downloading the required Unity version, steps 1-6._
...
2. Once in adobe, it should direct you to the creative cloud page of which you should click "Open Creative Cloud" once opened it should redirect you to a page that looks like this: ![](RackMultipart20221101-1-sfy10i_html_6c02d7320213a167.png)
3. It may also start on one of the other tabs so in case that happens just tab over to Creative Cloud and click Download.
4. Follow all the steps in the download process and once it has done it should take you to a page that looks like this: ![](RackMultipart20221101-1-sfy10i_html_8d53c6cfb1965df2.png)
5. If not, it may be a login which follows the same UW login system as the online system.
...
![](RackMultipart20221101-1-sfy10i_html_71bb6f5d821c2963.gif)

![](RackMultipart20221101-1-sfy10i_html_ffccaf20d87eeb4.gif)
...
![](RackMultipart20221101-1-sfy10i_html_7df9168640601b75.gif)
...
[XuidUnity](https://github.com/itouh2-i0plus/XuidUnity) is a plugin that will simplify the content creation pipeline by allowing us to export UI made in Adobe XD to Unity. The plugin and package are required for Adobe XD _ **AND** _ Unity, respectively.
      ...
      1. The plugins now come packaged with v1.0 of the SmartArt template and thus covered by the previous step.
...
![](RackMultipart20221101-1-sfy10i_html_2f1d0ecb6264cf2a.png)

![](RackMultipart20221101-1-sfy10i_html_f7f0541645a328e7.png)
...
![](RackMultipart20221101-1-sfy10i_html_38f9a340352f363.png)
...
![](RackMultipart20221101-1-sfy10i_html_fb41def4b5cc6191.png)

### Prefabs

To add more topic cards, go to the layers tab in the bottom left and then right click a topic and click duplicate. Drag and drop the Artboard into the area you would like and even sort them and label for easy export using a textbox outside of the artboards. Go to the Document Assets tab in the bottom left and chose the prefab text boxes as needed for slides and resize and position how you would like them to be. ![](RackMultipart20221101-1-sfy10i_html_6a1ee7a04a003620.png) ![](RackMultipart20221101-1-sfy10i_html_3205e169228f233a.png)

### Importing Adobe XD

Once cards are created, use the naming convention of "Topic/Poi#/CardName" before export as seen below: ![](RackMultipart20221101-1-sfy10i_html_1158df15d6ae8601.jpg)

Following this make sure to select all slides as if one is not selected or partially selected it may mess up the exporting process. ![](RackMultipart20221101-1-sfy10i_html_796cffdd860ada89.jpg)

In the top bar of Adobe XD go to "Plugins" and then "Xuid Unity Export"

The screen below should pop up, click the … in the Output section in which you should create a project folder somewhere on your computer to save these files to. If done correctly click Export and it should put the files into the correct folders. ![](RackMultipart20221101-1-sfy10i_html_e40e75f1491418c6.jpg)
